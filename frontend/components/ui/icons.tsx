...
export const ShareIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.05.586.075L21 12m-2.25 2.25l-2.25-2.25" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12c0-5.18-4.43-9.5-9.75-9.5S0 6.82 0 12s4.43 9.5 9.75 9.5 9.75-4.32 9.75-9.5z" />
  </svg>
);
...
export const UserGroupIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.228a4.5 4.5 0 00-1.897 1.897M15.75 10.5a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zM6 21a9 9 0 0018 0H6z" />
  </svg>
);
