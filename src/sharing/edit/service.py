...
@service_method()
async def update_share_permission_service(
        session,
        owner_id: int,
    ...
    share_record = await get_share_record(
...
@service_method()
async def update_shared_task_service(
    session,
    current_user_id: int,
    task_id: PrimaryKey,
...
@service_method()
async def toggle_shared_task_completion_status_service(
    session,
    current_user_id: int,
    task_id: int,
):
